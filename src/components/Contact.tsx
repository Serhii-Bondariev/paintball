...
const Contact = ({ onSocialClick }: ContactProps) => {
  ...
  const initialMessage = selectedPackage ? `Я хочу замовити пакет ${selectedPackage}: ${packages.find(p => p.title === selectedPackage)?.features.join(', ')}` : '';
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-orange-500">
            ...
            <form
              onSubmit={async (e) => {
                ...
                try {
                  ...
                  setFormError('Не вдалося відправити форму. Перевірте підключення або спробуйте пізніше.');
                }
              }}
            ...
            >
              ...
              {(formError || (Array.isArray(state.errors) && state.errors.length > 0)) && !state.succeeded && (
                <div
